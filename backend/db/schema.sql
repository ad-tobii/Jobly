...
-- ── Storage buckets ─────────────────────────────────────────────────────────
-- Both are public: the app hands out getPublicUrl() links for generated PDFs
-- and uploaded CVs. Switch to signed URLs if that isn't acceptable for you.
insert into storage.buckets (id, name, public)
values ('cvs', 'cvs', true), ('documents', 'documents', true)
